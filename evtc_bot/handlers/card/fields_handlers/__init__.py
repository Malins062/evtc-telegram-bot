...
from evtc_bot.handlers.card.fields_handlers.address import (
    router as address_handler_router,
)
from evtc_bot.handlers.card.fields_handlers.article import (
    router as article_handler_router,
)
...
from evtc_bot.handlers.card.fields_handlers.parking import (
    router as parking_handler_router,
)
from evtc_bot.handlers.card.fields_handlers.photo import router as photo_handler_router
from evtc_bot.handlers.card.fields_handlers.protocol import (
    router as protocol_handler_router,
)
